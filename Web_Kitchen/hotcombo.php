<?php
    ...
    $sql = "SELECT product_id, product.name as product_name, price, categories.name as category_name, image, combo 
            ...
            <div class="about_form">
                <div class="row" style="width:100%;">
                    <?php foreach($data as $product) : ?>
                        <div class ="col-3" style="margin-top: 10px; margin-left: 20px">
                ...
                <ul class="pagination justify-content-center">
                    <?php if ($page == 1) : ?>
                        <li class="page-item disabled">
                            <a class="page-link" href="hotcombo.php?page=<?= $page?>" aria-label="Previous">
                                <span aria-hidden="true">&laquo;</span>
                            </a>
                        </li>
                    <?php else:?>
                        <li class="page-item">
                            <a class="page-link" href="hotcombo.php?page=<?= $page-1?>" aria-label="Previous">
                                <span aria-hidden="true">&laquo;</span>
                            </a>
                        </li>
                    <?php endif ?>
                    ...
                    <?php if ($page >= $totalPage-1) : ?>
                        <li class="page-item disabled">
                            <a class="page-link" href="hotcombo.php?page=<?= $page?>" aria-label="Next">
                                <span aria-hidden="true">&raquo;</span>
                            </a>
                        </li>
                    <?php else:?>
                        <li class="page-item">
                            <a class="page-link" href="hotcombo.php?page=<?= $page+1?>" aria-label="Next">
                                <span aria-hidden="true">&raquo;</span>
                            </a>
                        </li>
                    <?php endif ?>
